...
#ifndef SEGWAY_MSGS__SRV__DETAIL__ROS_GET_VEL_MAX_FEEDBACK_CMD__FUNCTIONS_H_
#define SEGWAY_MSGS__SRV__DETAIL__ROS_GET_VEL_MAX_FEEDBACK_CMD__FUNCTIONS_H_
...
/// Initialize srv/RosGetVelMaxFeedbackCmd message.
/**
...
/// Finalize srv/RosGetVelMaxFeedbackCmd message.
/**
...
/// Create srv/RosGetVelMaxFeedbackCmd message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request__init().
...
/// Destroy srv/RosGetVelMaxFeedbackCmd message.
/**
 * It calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request__fini()
...
/// Check for srv/RosGetVelMaxFeedbackCmd message equality.
/**
...
/// Copy a srv/RosGetVelMaxFeedbackCmd message.
/**
...
/// Initialize array of srv/RosGetVelMaxFeedbackCmd messages.
/**
...
/// Finalize array of srv/RosGetVelMaxFeedbackCmd messages.
/**
 * It calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request__fini()
...
/// Create array of srv/RosGetVelMaxFeedbackCmd messages.
/**
 * It allocates the memory for the array and calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RosGetVelMaxFeedbackCmd messages.
/**
 * It calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RosGetVelMaxFeedbackCmd message array equality.
/**
...
/// Copy an array of srv/RosGetVelMaxFeedbackCmd messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_segway_msgs
...
/**
 * It calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_segway_msgs
...
/**
 * It allocates the memory for the array and calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_segway_msgs
...
/**
 * It calls
 * segway_msgs__srv__RosGetVelMaxFeedbackCmd_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SEGWAY_MSGS__SRV__DETAIL__ROS_GET_VEL_MAX_FEEDBACK_CMD__FUNCTIONS_H_
