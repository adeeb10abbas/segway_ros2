...
segway_msgs__srv__RosStopChassisRotateCmd_Request__are_equal(const segway_msgs__srv__RosStopChassisRotateCmd_Request * lhs, const segway_msgs__srv__RosStopChassisRotateCmd_Request * rhs)
{
  ...
  // ros_stopchassis_rotate_cmd
  if (lhs->ros_stopchassis_rotate_cmd != rhs->ros_stopchassis_rotate_cmd) {
    return false;
  }
  return true;
}
  ...
  segway_msgs__srv__RosStopChassisRotateCmd_Request * output)
{
  ...
  // ros_stopchassis_rotate_cmd
  output->ros_stopchassis_rotate_cmd = input->ros_stopchassis_rotate_cmd;
  return true;
}
...
segway_msgs__srv__RosStopChassisRotateCmd_Request__create()
{
  ...
  segway_msgs__srv__RosStopChassisRotateCmd_Request * msg = (segway_msgs__srv__RosStopChassisRotateCmd_Request *)allocator.allocate(sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Request));
  bool success = segway_msgs__srv__RosStopChassisRotateCmd_Request__init(msg);
  if (!success) {
...
segway_msgs__srv__RosStopChassisRotateCmd_Request__destroy(segway_msgs__srv__RosStopChassisRotateCmd_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    segway_msgs__srv__RosStopChassisRotateCmd_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence__init(segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  segway_msgs__srv__RosStopChassisRotateCmd_Request * data = NULL;

  if (size) {
    data = (segway_msgs__srv__RosStopChassisRotateCmd_Request *)allocator.zero_allocate(size, sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = segway_msgs__srv__RosStopChassisRotateCmd_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        segway_msgs__srv__RosStopChassisRotateCmd_Request__fini(&data[i - 1]);
      }
...
segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence__fini(segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      segway_msgs__srv__RosStopChassisRotateCmd_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence * array = (segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence *)allocator.allocate(sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence__init(array, size);
  if (!success) {
...
segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence__destroy(segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence__are_equal(const segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence * lhs, const segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!segway_msgs__srv__RosStopChassisRotateCmd_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  segway_msgs__srv__RosStopChassisRotateCmd_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    segway_msgs__srv__RosStopChassisRotateCmd_Request * data =
      (segway_msgs__srv__RosStopChassisRotateCmd_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!segway_msgs__srv__RosStopChassisRotateCmd_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          segway_msgs__srv__RosStopChassisRotateCmd_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!segway_msgs__srv__RosStopChassisRotateCmd_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  segway_msgs__srv__RosStopChassisRotateCmd_Response * msg = (segway_msgs__srv__RosStopChassisRotateCmd_Response *)allocator.allocate(sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Response));
  bool success = segway_msgs__srv__RosStopChassisRotateCmd_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
segway_msgs__srv__RosStopChassisRotateCmd_Response__destroy(segway_msgs__srv__RosStopChassisRotateCmd_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    segway_msgs__srv__RosStopChassisRotateCmd_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence__init(segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  segway_msgs__srv__RosStopChassisRotateCmd_Response * data = NULL;

  if (size) {
    data = (segway_msgs__srv__RosStopChassisRotateCmd_Response *)allocator.zero_allocate(size, sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = segway_msgs__srv__RosStopChassisRotateCmd_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        segway_msgs__srv__RosStopChassisRotateCmd_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence__fini(segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      segway_msgs__srv__RosStopChassisRotateCmd_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence * array = (segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence *)allocator.allocate(sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence__destroy(segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence__are_equal(const segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence * lhs, const segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!segway_msgs__srv__RosStopChassisRotateCmd_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  segway_msgs__srv__RosStopChassisRotateCmd_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(segway_msgs__srv__RosStopChassisRotateCmd_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    segway_msgs__srv__RosStopChassisRotateCmd_Response * data =
      (segway_msgs__srv__RosStopChassisRotateCmd_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!segway_msgs__srv__RosStopChassisRotateCmd_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          segway_msgs__srv__RosStopChassisRotateCmd_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!segway_msgs__srv__RosStopChassisRotateCmd_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
