//
// Created by Adeeb Abbas on 3/27/20.
//
...
struct Odometry{
     ...
     * Author: Adeeb Abbas
     * translation:
     *      nav_msgs::msg::Odometry o->header.stamp <- TimeStamp
     *      nav_msgs::msg::Odometry o->pose.pose.position(pose_.x,pose_.y,0)
     *      nav_msgs::msg::Odometry o->pose.pose.orientation(0,0,sin(pose_.orientation/2),cos(pose_.orientation/2))
     *      nav_msgs::msg::Odometry o->twist.twist.linear(v_x, v_y, 0)
     *      nav_msgs::msg::Odometry o->twist.twist.angular(0, 0, w_z)
    */
    struct Pose{
//        int64_t TimeStamp = -1;
        double x = 0;
